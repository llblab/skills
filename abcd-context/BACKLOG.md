...
- [ ] `Document coexistence with stricter project-local overlays:` explain how `abcd-context` should hand off to repository-specific gatekeepers and alignment skills without duplicating their rules.
